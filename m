Return-Path: <jailhouse-dev+bncBCB7D7MXMMIKXCFK5ICRUBG7AA37Y@googlegroups.com>
X-Original-To: lists+jailhouse-dev@lfdr.de
Delivered-To: lists+jailhouse-dev@lfdr.de
Received: from mail-vk1-xa39.google.com (mail-vk1-xa39.google.com [IPv6:2607:f8b0:4864:20::a39])
	by mail.lfdr.de (Postfix) with ESMTPS id BC6B484675
	for <lists+jailhouse-dev@lfdr.de>; Wed,  7 Aug 2019 09:56:28 +0200 (CEST)
Received: by mail-vk1-xa39.google.com with SMTP id o202sf38804622vko.16
        for <lists+jailhouse-dev@lfdr.de>; Wed, 07 Aug 2019 00:56:28 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1565164587; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:reply-to:mime-version:references
         :in-reply-to:message-id:date:subject:cc:to:from:dkim-signature;
        bh=rQNARYic1ZTRsHbewgnvJ4GW2/bIVQ9ujA89wQpVgVg=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@ti.com header.s=ti-com-17Q1 header.b=RRtGH0Z+;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=rQNARYic1ZTRsHbewgnvJ4GW2/bIVQ9ujA89wQpVgVg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=rQNARYic1ZTRsHbewgnvJ4GW2/bIVQ9ujA89wQpVgVg=;
        b=
X-Gm-Message-State: APjAAAX2A8bCUZ3zV0pWNxIDsDG0QWyH657aS/rTiE+0y3mTnEvHiLW5
	q5rsIoGRK/SxzaTlOPUbm5U=
X-Google-Smtp-Source: APXvYqyvvegTu4AYKeneW0sTlq5Jqc+wVCdrqe8nQrKSE30+bphJhVOSRNbthwmD7MMOiAgFQrB4Wg==
X-Received: by 2002:a67:c994:: with SMTP id y20mr5025307vsk.231.1565164587723;
        Wed, 07 Aug 2019 00:56:27 -0700 (PDT)
X-BeenThere: jailhouse-dev@googlegroups.com
Received: by 2002:a1f:9dc9:: with SMTP id g192ls3825915vke.1.gmail; Wed, 07
 Aug 2019 00:56:27 -0700 (PDT)
X-Received: by 2002:a1f:4107:: with SMTP id o7mr2940832vka.34.1565164587217;
        Wed, 07 Aug 2019 00:56:27 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1565164587; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:dkim-signature;
        bh=HKRzFl6NCx8/sMNW38gi+TY/Uh5EskrRWoFdhpkvMGo=;
        b=
...
Received: from fllv0016.ext.ti.com (fllv0016.ext.ti.com. [198.47.19.142])
        by gmr-mx.google.com with ESMTPS id z67si4282999vsb.1.2019.08.07.00.56.27
...
Received: from fllv0035.itg.ti.com ([10.64.41.0])
	by fllv0016.ext.ti.com (8.15.2/8.15.2) with ESMTP id x777uQHO114610;
	Wed, 7 Aug 2019 02:56:26 -0500
Received: from DFLE113.ent.ti.com (dfle113.ent.ti.com [10.64.6.34])
	by fllv0035.itg.ti.com (8.15.2/8.15.2) with ESMTPS id x777uQKN059360
...
Received: from fllv0040.itg.ti.com (10.64.41.20) by DFLE108.ent.ti.com
 ...
 Frontend Transport; Wed, 7 Aug 2019 02:56:26 -0500
Received: from uda0131933.india.ti.com (ileax41-snat.itg.ti.com [10.172.224.153])
	by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id x777uBmX128703;
...
Subject: [PATCH v5 5/6] arm64: iommu: smmu-v3: Add data structure initialization and stage 2 for SMMUv3
Date: Wed, 7 Aug 2019 13:25:29 +0530
Message-ID: <20190807075530.30444-6-lokeshvutla@ti.com>
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@ti.com header.s=ti-com-17Q1 header.b=RRtGH0Z+;       spf=pass
...
---
 ...
 hypervisor/arch/arm64/smmu-v3.c | 1128 +++++++++++++++++++++++++++++++
...
To view this discussion on the web visit https://groups.google.com/d/msgid/jailhouse-dev/20190807075530.30444-6-lokeshvutla%40ti.com.
