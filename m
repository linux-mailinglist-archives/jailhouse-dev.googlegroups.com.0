Return-Path: <jailhouse-dev+bncBCJI7SMNV4NBBB4BVH3QKGQEI5RPQMY@googlegroups.com>
X-Original-To: lists+jailhouse-dev@lfdr.de
Delivered-To: lists+jailhouse-dev@lfdr.de
Received: from mail-wr1-x43a.google.com (mail-wr1-x43a.google.com [IPv6:2a00:1450:4864:20::43a])
	by mail.lfdr.de (Postfix) with ESMTPS id ACF141FD197
	for <lists+jailhouse-dev@lfdr.de>; Wed, 17 Jun 2020 18:10:47 +0200 (CEST)
Received: by mail-wr1-x43a.google.com with SMTP id c14sf1561786wrw.11
        for <lists+jailhouse-dev@lfdr.de>; Wed, 17 Jun 2020 09:10:47 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1592410247; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=2DKS13DJ+j7tBHHIhPEjlVmrIwBlQcwGTcd/RfgiOjQ=;
        b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=2DKS13DJ+j7tBHHIhPEjlVmrIwBlQcwGTcd/RfgiOjQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=sender:x-gm-message-state:subject:to:cc:references:from:message-id
         ...
         :list-subscribe:list-unsubscribe;
        bh=2DKS13DJ+j7tBHHIhPEjlVmrIwBlQcwGTcd/RfgiOjQ=;
        b=
Sender: jailhouse-dev@googlegroups.com
X-Gm-Message-State: AOAM530lb6cQo3RZbYHF6gp/wF5MzWraM3zvOuA9U3pUpMCdKqMALoXt
	FNxFFhO+06yqZqqf+4b4hic=
X-Google-Smtp-Source: ABdhPJy92PQnpbaEIWdxrYuYDaCGZeRjlstlOpbF229YNOreJa9ZBpiCQ4NxFnHS9uPy3f5MEcRS0Q==
X-Received: by 2002:adf:e78a:: with SMTP id n10mr23272wrm.114.1592410247374;
        Wed, 17 Jun 2020 09:10:47 -0700 (PDT)
X-BeenThere: jailhouse-dev@googlegroups.com
Received: by 2002:adf:aace:: with SMTP id i14ls3910327wrc.3.gmail; Wed, 17 Jun
 2020 09:10:46 -0700 (PDT)
X-Received: by 2002:a05:6000:1289:: with SMTP id f9mr9436287wrx.5.1592410246587;
        Wed, 17 Jun 2020 09:10:46 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1592410246; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:content-language:in-reply-to:mime-version
         :user-agent:date:message-id:from:references:cc:to:subject;
        bh=iYhdxAO91NB9xb1EOCfc/q33Vpt2BeOEuxFr+jH3PZY=;
        b=
ARC-Authentication-Results: i=1; gmr-mx.google.com;
       spf=pass (google.com: domain of jan.kiszka@siemens.com designates 194.138.37.40 as permitted sender) smtp.mailfrom=jan.kiszka@siemens.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=siemens.com
Received: from gecko.sbs.de (gecko.sbs.de. [194.138.37.40])
        by gmr-mx.google.com with ESMTPS id w126si421046wma.4.2020.06.17.09.10.46
...
On 17.06.20 17:32, Alex Benn=C3=A9e wrote:
>=20
...
>> |        |                        | Bit 0: I/O Space (if Register Region=
 uses I/O)       |
>> |        |                        | Bit 1: Memory Space (if Register Reg=
ion uses Memory) |
>> |        |                        | Bit 3: Bus Master                   =
                 |
...
>> |    06h | Status Register        | 0010h, static value                 =
                 |
>> |        |                        | In deviation to the PCI specificatio=
n, the Interrupt |
...
>> |    01h | Next Capability     | Pointer to next capability or 00h      =
        |
>> |    02h | Length              | 20h if Base Address is present, 18h oth=
erwise  |
>> |    03h | Privileged Control  | Bit 0 (read/write): one-shot interrupt =
mode    |
>> |        |                     | Bits 1-7: Reserved (0 on read, writes i=
gnored) |
...
>>
>> Implementations of the Doorbell register must ensure that data written b=
y the
...
jailhouse-dev/c798bf36-162f-5474-4e21-efcc0d7c295e%40siemens.com.
