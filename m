...
Received: from mail-wr1-x43b.google.com (mail-wr1-x43b.google.com [IPv6:2a00:1450:4864:20::43b])
	by mail.lfdr.de (Postfix) with ESMTPS id 25436364CD9
	for <lists+jailhouse-dev@lfdr.de>; Mon, 19 Apr 2021 23:10:13 +0200 (CEST)
Received: by mail-wr1-x43b.google.com with SMTP id h60-20020adf90420000b029010418c4cd0csf8804275wrh.12
        for <lists+jailhouse-dev@lfdr.de>; Mon, 19 Apr 2021 14:10:13 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1618866613; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:mime-version:references:in-reply-to
         :message-id:date:subject:to:from:sender:dkim-signature;
        bh=D94ZD07j1wQP2WgXuXrW0p8pXeboHCweP7wiqAzQRJA=;
        b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=D94ZD07j1wQP2WgXuXrW0p8pXeboHCweP7wiqAzQRJA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=sender:x-gm-message-state:from:to:subject:date:message-id
         ...
         :list-subscribe:list-unsubscribe;
        bh=D94ZD07j1wQP2WgXuXrW0p8pXeboHCweP7wiqAzQRJA=;
        b=
Sender: jailhouse-dev@googlegroups.com
X-Gm-Message-State: AOAM533Ef+lzAUAWG8XTezyjvzODCMY85dQ2l9g0m/DLfosZpqgIyar3
	OCBd1ZFNmu/ebhD9ZLlcYzs=
X-Google-Smtp-Source: ABdhPJxRDWsVPPLrHdwcWGcUe0xAa3n1RTAaeSAtUT4ZKQ2kKPiSyCvYjbhWshHFDTxKaXLyFu+/Aw==
X-Received: by 2002:a1c:7e45:: with SMTP id z66mr937010wmc.126.1618866612423;
        Mon, 19 Apr 2021 14:10:12 -0700 (PDT)
X-BeenThere: jailhouse-dev@googlegroups.com
Received: by 2002:a05:600c:4a04:: with SMTP id c4ls302280wmp.1.gmail; Mon, 19
 Apr 2021 14:10:11 -0700 (PDT)
X-Received: by 2002:a7b:c415:: with SMTP id k21mr956405wmi.146.1618866610715;
        Mon, 19 Apr 2021 14:10:10 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1618866610; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:to:from;
        bh=r+9BMYT6NWwntyL8DmFqW6lBDkuBoTsf1SlWWkVKfBo=;
        b=
ARC-Authentication-Results: i=1; gmr-mx.google.com;
       spf=pass (google.com: domain of jan.kiszka@siemens.com designates 194.138.37.40 as permitted sender) smtp.mailfrom=jan.kiszka@siemens.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=siemens.com
Received: from gecko.sbs.de (gecko.sbs.de. [194.138.37.40])
        by gmr-mx.google.com with ESMTPS id s21si45383wmh.2.2021.04.19.14.10.10
        for <jailhouse-dev@googlegroups.com>
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 19 Apr 2021 14:10:10 -0700 (PDT)
Received-SPF: pass (google.com: domain of jan.kiszka@siemens.com designates 194.138.37.40 as permitted sender) client-ip=194.138.37.40;
Received: from mail2.sbs.de (mail2.sbs.de [192.129.41.66])
	by gecko.sbs.de (8.15.2/8.15.2) with ESMTPS id 13JLAAF0026824
	(version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
	for <jailhouse-dev@googlegroups.com>; Mon, 19 Apr 2021 23:10:10 +0200
Received: from md1f2u6c.ad001.siemens.net ([167.87.240.116])
	by mail2.sbs.de (8.15.2/8.15.2) with ESMTP id 13JL6Tpd015242
	for <jailhouse-dev@googlegroups.com>; Mon, 19 Apr 2021 23:06:32 +0200
From: Jan Kiszka <jan.kiszka@siemens.com>
To: jailhouse-dev@googlegroups.com
Subject: [jh-images][PATCH v2 10/20] non-root-initramfs: Update to buildroot 2021.02
Date: Mon, 19 Apr 2021 23:06:19 +0200
Message-Id: <3d352094247f075ab92a66edc989b6acb991fbf9.1618866389.git.jan.kiszka@siemens.com>
...
Switch to defconfigs as this chance.
...
---
 ...
 ....11.1.bb => non-root-initramfs_2021.02.bb} |    2 +-
 4 files changed, 4 insertions(+), 11438 deletions(-)
 rename recipes-core/non-root-initramfs/{non-root-initramfs_2019.11.1.bb => non-root-initramfs_2021.02.bb} (90%)

diff --git a/recipes-core/non-root-initramfs/files/amd64-config b/recipes-core/non-root-initramfs/files/amd64-config
index be8856a..775f1ac 100644
...
-
-#
-# gstreamer 0.10 needs a toolchain w/ wchar, threads, dynamic library
-#
-
-#
...
-
-#
-# amd-catalyst needs a glibc toolchain
-#
-
-#
...
-
-#
-# libcpprestsdk needs a toolchain w/ NPTL, C++, wchar
-#
...
-# BR2_PACKAGE_GCC_TARGET is not set
-# BR2_HAVE_DEVFILES is not set
diff --git a/recipes-core/non-root-initramfs/non-root-initramfs_2019.11.1.bb b/recipes-core/non-root-initramfs/non-root-initramfs_2021.02.bb
similarity index 90%
rename from recipes-core/non-root-initramfs/non-root-initramfs_2019.11.1.bb
rename to recipes-core/non-root-initramfs/non-root-initramfs_2021.02.bb
index a250d9e..48f2886 100644
--- a/recipes-core/non-root-initramfs/non-root-initramfs_2019.11.1.bb
...
To view this discussion on the web visit https://groups.google.com/d/msgid/jailhouse-dev/3d352094247f075ab92a66edc989b6acb991fbf9.1618866389.git.jan.kiszka%40siemens.com.
