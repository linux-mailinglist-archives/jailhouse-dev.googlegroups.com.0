...
Received: from mail-ej1-x63e.google.com (mail-ej1-x63e.google.com [IPv6:2a00:1450:4864:20::63e])
	by mail.lfdr.de (Postfix) with ESMTPS id 6329538C51C
	for <lists+jailhouse-dev@lfdr.de>; Fri, 21 May 2021 12:41:18 +0200 (CEST)
Received: by mail-ej1-x63e.google.com with SMTP id z1-20020a1709068141b02903cd421d7803sf6019461ejw.22
        for <lists+jailhouse-dev@lfdr.de>; Fri, 21 May 2021 03:41:18 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1621593678; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:mime-version:references:in-reply-to
         :message-id:date:subject:to:from:sender:dkim-signature;
        bh=aR4Gowt+IxYxdAPCcJxZ6vEKL/2wrYYweQwRqjaYbrg=;
        b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=aR4Gowt+IxYxdAPCcJxZ6vEKL/2wrYYweQwRqjaYbrg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=sender:x-gm-message-state:from:to:subject:date:message-id
         ...
         :list-subscribe:list-unsubscribe;
        bh=aR4Gowt+IxYxdAPCcJxZ6vEKL/2wrYYweQwRqjaYbrg=;
        b=
Sender: jailhouse-dev@googlegroups.com
X-Gm-Message-State: AOAM530xBRJMCl180zSxJY2CnSS7Vef0QCnYAwC+J2K2mU229ozDw1fb
	IyqWFWQPlPzJ5eoRY/F2TKk=
X-Google-Smtp-Source: ABdhPJwFVglVljOK0VdZrGSaESxvbHkHBQbEmEyBtjzvM6yhzmQMKdqtrPhiEUhH0QURGwncH4L/0g==
X-Received: by 2002:a50:eb47:: with SMTP id z7mr10733509edp.68.1621593677781;
        Fri, 21 May 2021 03:41:17 -0700 (PDT)
X-BeenThere: jailhouse-dev@googlegroups.com
Received: by 2002:a50:e046:: with SMTP id g6ls121307edl.3.gmail; Fri, 21 May
 2021 03:41:16 -0700 (PDT)
X-Received: by 2002:aa7:c9c9:: with SMTP id i9mr10392775edt.17.1621593676011;
        Fri, 21 May 2021 03:41:16 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1621593676; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:to:from;
        bh=r+9BMYT6NWwntyL8DmFqW6lBDkuBoTsf1SlWWkVKfBo=;
        b=
ARC-Authentication-Results: i=1; gmr-mx.google.com;
       spf=pass (google.com: domain of jan.kiszka@siemens.com designates 194.138.37.40 as permitted sender) smtp.mailfrom=jan.kiszka@siemens.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=siemens.com
Received: from gecko.sbs.de (gecko.sbs.de. [194.138.37.40])
        by gmr-mx.google.com with ESMTPS id o17si90058edc.4.2021.05.21.03.41.15
        for <jailhouse-dev@googlegroups.com>
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Fri, 21 May 2021 03:41:15 -0700 (PDT)
Received-SPF: pass (google.com: domain of jan.kiszka@siemens.com designates 194.138.37.40 as permitted sender) client-ip=194.138.37.40;
Received: from mail2.sbs.de (mail2.sbs.de [192.129.41.66])
	by gecko.sbs.de (8.15.2/8.15.2) with ESMTPS id 14LAfFn6021699
	(version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
	for <jailhouse-dev@googlegroups.com>; Fri, 21 May 2021 12:41:15 +0200
Received: from md1f2u6c.ad001.siemens.net ([167.87.240.49])
	by mail2.sbs.de (8.15.2/8.15.2) with ESMTP id 14LAbYcF032504
	for <jailhouse-dev@googlegroups.com>; Fri, 21 May 2021 12:37:37 +0200
From: Jan Kiszka <jan.kiszka@siemens.com>
To: jailhouse-dev@googlegroups.com
Subject: [jh-images][PATCH v3 10/22] non-root-initramfs: Update to buildroot 2021.02
Date: Fri, 21 May 2021 12:37:22 +0200
Message-Id: <4af5e9537222a73581f31f3d8b96311bbb4dd9d8.1621593454.git.jan.kiszka@siemens.com>
...
To view this discussion on the web visit https://groups.google.com/d/msgid/jailhouse-dev/4af5e9537222a73581f31f3d8b96311bbb4dd9d8.1621593454.git.jan.kiszka%40siemens.com.
